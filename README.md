...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/tasks#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tasks
```

A live public deployment of this template is available at [https://tasks.templates.workers.dev](https://tasks.templates.workers.dev)
